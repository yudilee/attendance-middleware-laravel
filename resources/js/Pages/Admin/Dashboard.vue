                        ...
                        <tr v-for="punch in recent_punches" :key="punch.id" class="hover:bg-slate-800/40 transition">
                            ...
                            <td class="px-4 py-3">
                                <span :class="[
                                    ...
                                    punch.punch_type === 'In' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20'
                                ]">
                                    {{ punch.punch_type }}
                                </span>
                            </td>
                            <td class="px-4 py-3 text-slate-300 font-mono text-xs">{{ punch.timestamp }}</td>
                            ...
                            <td class="px-4 py-3 text-xs">
                                <span v-if="punch.biometric_verified" class="text-emerald-400 font-semibold">Verified</span>
